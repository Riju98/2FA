...
// New method to verify the TOTP token
UserSchema.method('verifyTwoFactorToken', function (token) {
...
// New method to generate a TOTP secret
UserSchema.static('generateTwoFactorSecret', function () {
    const speakeasy = require('speakeasy');
    return speakeasy.generateSecret({ name: 'OpenHAB' });
});
